...
public class ContainerCalcinator extends ContainerEE {
    ...
    public ContainerCalcinator(InventoryPlayer inventoryPlayer, TileEntityCalcinator tileEntityCalcinator) {
        ...
        this.addSlotToContainer(
            new SlotCalcinator(tileEntityCalcinator, TileEntityCalcinator.OUTPUT_LEFT_INVENTORY_INDEX, 105, 29));
        this.addSlotToContainer(
            new SlotCalcinator(tileEntityCalcinator, TileEntityCalcinator.OUTPUT_RIGHT_INVENTORY_INDEX, 125, 29));
    ...
    public ItemStack transferStackInSlot(EntityPlayer entityPlayer, int slotIndex) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotIndex < TileEntityCalcinator.INVENTORY_SIZE) {
                if (!this
                    .mergeItemStack(slotItemStack, TileEntityCalcinator.INVENTORY_SIZE, inventorySlots.size(), false)) {
                    return null;
                }
            } else {
                /**
    ...
    private class SlotCalcinator extends Slot {
        ...
        public void onPickupFromSlot(EntityPlayer entityPlayer, ItemStack itemStack) {
            ...
            FMLCommonHandler.instance()
                .firePlayerCraftingEvent(entityPlayer, itemStack, inventory);
        }
