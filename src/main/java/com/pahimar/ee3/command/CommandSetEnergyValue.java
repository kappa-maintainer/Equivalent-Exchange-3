            ...
            if (wrappedStack != null && newEnergyValue != null) {
                if (Float.compare(newEnergyValue.getValue(), 0) > 0) {
                    ...
                    func_152373_a(
                        ...
                        new Object[] { commandSender.getCommandSenderName(), args[1], itemStack.func_151000_E(),
                    ...
                    PacketHandler.INSTANCE
                        .sendToAll(new MessageSetBlacklistEntry(itemStack, BlacklistRegistryProxy.Blacklist.KNOWLEDGE));
                    PacketHandler.INSTANCE
                        .sendToAll(new MessageSetBlacklistEntry(itemStack, BlacklistRegistryProxy.Blacklist.EXCHANGE));
                    func_152373_a(
                        commandSender,
                        this,
