...
public class ItemTooltipEventHandler {
    ...
    public void handleItemTooltipEvent(ItemTooltipEvent event) {
        ...
        if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) || Keyboard.isKeyDown(Keyboard.KEY_RSHIFT)
            || (event.entityPlayer != null && (event.entityPlayer.openContainer instanceof ContainerAlchenomicon
            ...
            if (energyValue != null) {
                ...
                if (wrappedItemStack.getStackSize() > 1) {
                    ...
                    event.toolTip.add(
                        String
                            .format("Exchange Energy (Stack of %s): %s", event.itemStack.stackSize, stackEnergyValue)); // TODO
                                                                                                                        // Localize
                } else {
                        ...
                        if (fluidStackEnergyValue != null) {
                            ...
                            event.toolTip.add(
                                String.format(
                                    ...
                                    new EnergyValue(energyValue.getValue() - fluidStackEnergyValue.getValue()))); // TODO
                                                                                                                  // Localize
                        }
                    }
                }
        ...
        if (((Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) || Keyboard.isKeyDown(Keyboard.KEY_RSHIFT))
            && (event.entityPlayer != null && event.entityPlayer.openContainer instanceof ContainerResearchStation))) {
