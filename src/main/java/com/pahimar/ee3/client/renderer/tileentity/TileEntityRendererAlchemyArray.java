...
public class TileEntityRendererAlchemyArray extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
        if (tileEntity instanceof TileEntityAlchemyArray) {
            TileEntityAlchemyArray tileEntityAlchemyArray = (TileEntityAlchemyArray) FMLClientHandler.instance()
                .getClient().theWorld.getTileEntity(tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord);
            ...
            if (tileEntityAlchemyArray != null) {
                ...
                if (alchemyArray != null) {
                    if (alchemyArray instanceof ICustomAlchemyArrayRender) {
                        ((ICustomAlchemyArrayRender) alchemyArray).doCustomRendering(
                            tileEntity,
                            x,
                            y,
                            z,
