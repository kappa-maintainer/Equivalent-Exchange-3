...
public class AludelRecipeProxy {
    ...
    public void addRecipe(ItemStack recipeOutput, ItemStack recipeInputStack, ItemStack recipeInputDust) {
        ...
        if (ee3Mod != null) {
            EE3Wrapper.ee3mod.getAludelRecipeManager()
                .addRecipe(recipeOutput, recipeInputStack, recipeInputDust);
        }
    }
    ...
    public ItemStack getResult(ItemStack recipeInputStack, ItemStack recipeInputDust) {
        ...
        if (ee3Mod != null) {
            return EE3Wrapper.ee3mod.getAludelRecipeManager()
                .getResult(recipeInputStack, recipeInputDust);
        }
