...
public class Recipes {
    ...
    private static void initModRecipes() {
        ...
        GameRegistry
            .addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.diviningRod), " s ", " s ", "s s", 's', "stickWood"));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ModBlocks.augmentationTable),
                "i  ",
                "sss",
                "p p",
                'i',
        ...
        GameRegistry.addShapedRecipe(
            new ItemStack(ModItems.shovelDarkMatter),
            "m",
            "d",
            "d",
            'm',
            new ItemStack(ModItems.matter, 1, 0),
            'd',
            Items.diamond);
        GameRegistry.addShapedRecipe(
            new ItemStack(ModItems.pickAxeDarkMatter),
            "mmm",
            " d ",
            " d ",
            'm',
            ...
            Items.diamond);
        GameRegistry.addShapedRecipe(
            new ItemStack(ModItems.hammerDarkMatter),
            "mmm",
            "mdm",
            " d ",
            'm',
            ...
            Items.diamond);
        GameRegistry.addShapedRecipe(
            new ItemStack(ModItems.axeDarkMatter),
            "mm ",
            "md ",
            " d ",
            'm',
            ...
            Items.diamond);
        GameRegistry.addShapedRecipe(
            new ItemStack(ModItems.hoeDarkMatter),
            "mm ",
            " d ",
            " d ",
            'm',
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ModItems.fishingRodDarkMatter),
                "  w",
                " ws",
                "m s",
                'm',
        ...
        GameRegistry.addShapedRecipe(
            new ItemStack(ModItems.shearsDarkMatter),
            "m ",
            " m",
            'm',
            new ItemStack(ModItems.matter, 1, 0));
        ...
        GameRegistry.addShapedRecipe(
            new ItemStack(ModItems.bowDarkMatter),
            "sm ",
            "s m",
            "sm ",
            'm',
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ModItems.arrowDarkMatter, 64),
                "  m",
                " s ",
                "f  ",
                'm',
        ...
        GameRegistry.addShapedRecipe(
            new ItemStack(ModItems.swordDarkMatter),
            "m",
            "m",
            "d",
            'm',
    ...
    private static void initAludelRecipes() {
        // Ash + Verdant = Azure
        AludelRecipeManager.getInstance()
            .addRecipe(
