            ...
            if (wrappedStack1.wrappedStack instanceof ItemStack) {
                ...
                if (wrappedStack2.wrappedStack instanceof ItemStack) {
                    ...
                    int compareResult = ItemStackUtils
                        .compare((ItemStack) wrappedStack1.wrappedStack, (ItemStack) wrappedStack2.wrappedStack);
                ...
                if (wrappedStack2.wrappedStack instanceof ItemStack) {
                    ...
                    int compareResult = OreStack
                        .compare((OreStack) wrappedStack1.wrappedStack, (OreStack) wrappedStack2.wrappedStack);
                ...
                if (wrappedStack2.wrappedStack instanceof ItemStack || wrappedStack2.wrappedStack instanceof OreStack) {
                    ...
                    int compareResult = FluidHelper
                        .compare((FluidStack) wrappedStack1.wrappedStack, (FluidStack) wrappedStack2.wrappedStack);
