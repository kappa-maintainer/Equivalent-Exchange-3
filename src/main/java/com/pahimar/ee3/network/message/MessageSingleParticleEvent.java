...
public class MessageSingleParticleEvent implements IMessage, IMessageHandler<MessageSingleParticleEvent, IMessage> {
    ...
    public MessageSingleParticleEvent(String particleName, double xCoord, double yCoord, double zCoord,
    ...
    public void fromBytes(ByteBuf byteBuf) {
        ...
        this.particleName = new String(
            byteBuf.readBytes(particleNameLength)
                .array());
