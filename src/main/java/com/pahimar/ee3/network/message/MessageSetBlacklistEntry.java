        ...
        if (blacklistOrdinal >= 0) {
            ...
            if (blacklist != null) {
                ...
                if (compressedJsonLength != 0) {
                    ...
                    byte[] compressedWrappedStack = buf.readBytes(compressedJsonLength)
                        .array();
    ...
    public void toBytes(ByteBuf buf) {
        ...
        if (blacklist != null) {
            ...
            if (wrappedStack != null && wrappedStack.getWrappedObject() != null) {
                ...
                byte[] compressedWrappedStack = CompressionHelper
                    .compress(SerializationHelper.GSON.toJson(wrappedStack));
