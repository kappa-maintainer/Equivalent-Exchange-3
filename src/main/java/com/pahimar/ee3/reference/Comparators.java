...
public class Comparators {
                            ...
                            if ((itemStack1.getItemDamage() == itemStack2.getItemDamage())
                                ...
                                if (itemStack1.hasTagCompound() && itemStack2.hasTagCompound()) {
                                    ...
                                    if (ItemStack.areItemStackTagsEqual(itemStack1, itemStack2)) {
                                        ...
                                        return (itemStack1.getTagCompound()
                                            .hashCode()
    ...
    public static final Comparator<ItemStack> DISPLAY_NAME_COMPARATOR = new Comparator<ItemStack>() {
        ...
        public int compare(ItemStack itemStack1, ItemStack itemStack2) {
            if (itemStack1 != null && itemStack2 != null) {
                if (itemStack1.getDisplayName()
                    .equalsIgnoreCase(itemStack2.getDisplayName())) {
                    return ID_COMPARATOR.compare(itemStack1, itemStack2);
                } else {
                    return itemStack1.getDisplayName()
                        .compareToIgnoreCase(itemStack2.getDisplayName());
                }
            } else if (itemStack1 != null) {
                return -1;
            } else if (itemStack2 != null) {
                ...
                if (EnergyValueRegistryProxy.hasEnergyValue(itemStack1)
                    ...
                    return Float.compare(
                        EnergyValueRegistryProxy.getEnergyValue(itemStack1)
                            .getValue(),
                        EnergyValueRegistryProxy.getEnergyValue(itemStack2)
                            .getValue());
                } else {
                    return ID_COMPARATOR.compare(itemStack1, itemStack2);
                }
