...
public class ElementListBox extends ElementBase {
        ...
        while (nextElement < e && heightDrawn <= getContentHeight()) {
            if (nextElement == _selectedIndex) {
                _elements.get(nextElement)
                    .draw(this, getContentLeft(), getContentTop() + heightDrawn, selectedLineColor, selectedTextColor);
            } else {
                _elements.get(nextElement)
                    .draw(this, getContentLeft(), getContentTop() + heightDrawn, backgroundColor, textColor);
            }
            heightDrawn += _elements.get(nextElement)
                .getHeight();
            nextElement++;
        }
    ...
    public int getLastScrollPosition() {
        ...
        int heightUsed = _elements.get(position)
            .getHeight();
